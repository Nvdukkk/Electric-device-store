...
export default function NotFound() {
  return (
    <div>
      <div className="background_404 position-absolute w-100 h-100 ">
        <div className="bg-black position-absolute bottom-0 w-100 h-5 d-md-block d-none"></div>
      </div>
      <div className="pb-0 pb-md-5 position-relative my-0 mx-auto w-75 vh-100 d-flex flex-col justify-content-around flex-md-row ">
        <div className="position-relative  w-40 w-100">
